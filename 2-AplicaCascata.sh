...
ENTIDADES_NOMEADAS=('LOCAL' 'PESSOA' 'ORGANIZACAO' 'ABSTRACCAO' 'ACONTECIMENTO' 'COISA' 'OBRA' 'TEMPO' 'VALOR' 'OUTRO', 'LOCAL-LOCAL_NASCIMENTO' 'PESSOA-RELACAO_FAMILIAR' 'PESSOA-LOCAL_NASCIMENTO' 'PESSOA-IDENT' 'LOCAL-OCORRE_EM' 'ORGANIZACAO-OCORRE_EM' 'LOCAL-INCLUI' 'ACONTECIMENTO-SEDE_DE' 'LOCAL-SEDE_DE' 'ORGANIZACAO-SEDE_DE' )
