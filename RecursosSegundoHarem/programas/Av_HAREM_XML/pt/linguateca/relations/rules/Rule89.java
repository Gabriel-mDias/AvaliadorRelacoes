...
public class Rule89 extends TransitiveRule{

	// 8 - inclui(A, B) e sede_de(B,C ) -> sede_de (A, C )
	// 9 - incluido(A, B) e ocorre_em(B, C) -> ocorre_em (A, C)
	
	public Rule89(TagBase tags) {
		super(tags, Relation.INCLUI, Relation.SEDE);
	}
