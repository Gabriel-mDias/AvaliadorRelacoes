...
public class RelationEvaluationScriptGenerator implements Runnable
{
	...
	private static final String INVOKE_SELECTOR =
		"java -Dfile.encoding=ISO-8859-1 -cp .;lib/jdom.jar pt.linguateca.harem.AlignmentSelector -alinhamento "+NAME+".rerelem2.alinhado.avalida."+FILTER_SUFFIX+".alts > "+NAME+".rerelem2.alinhado.avalida."+FILTER_SUFFIX+".alts.selec";
	
	private static final String INVOKE_ID_NORMALIZER =
		"java -Dfile.encoding=ISO-8859-1 -cp .;lib/jdom.jar pt.linguateca.harem.IDNormalizer -alinhamento "+NAME+".rerelem2.alinhado.avalida."+FILTER_SUFFIX+".alts.selec > "+NAME+".rerelem2.alinhado.avalida."+FILTER_SUFFIX+".alts.selec.norm";

	private static final String INVOKE_EXPANDER =
		"java -Dfile.encoding=ISO-8859-1 -cp .;lib/jdom.jar pt.linguateca.harem.RelationExpanderM2 -alinhamento "+NAME+".rerelem2.alinhado.avalida."+FILTER_SUFFIX+".alts.selec.norm > "+NAME+".rerelem2.alinhado.avalida."+FILTER_SUFFIX+".alts.selec.norm.exp";

	private static final String INVOKE_RELATIONS_FILTER =
		"java -Dfile.encoding=ISO-8859-1 -cp .;lib/jdom.jar pt.linguateca.harem.RelationsFilter -alinhamento "+NAME+".rerelem2.alinhado.avalida."+FILTER_SUFFIX+".alts.selec.norm.exp "+REL_FILTER+" > "+NAME+".rerelem2.alinhado.avalida."+FILTER_SUFFIX+".alts.selec.norm.exp."+REL_FILTER_SUFFIX;

	private static final String INVOKE_RELATIONS_EVALUATOR =
		"java -Dfile.encoding=ISO-8859-1 -cp .;lib/jdom.jar pt.linguateca.harem.RelationsEvaluatorM2 -alinhamento "+NAME+".rerelem2.alinhado.avalida."+FILTER_SUFFIX+".alts.selec.norm.exp."+REL_FILTER_SUFFIX+" > "+NAME+".rerelem2.alinhado.avalida."+FILTER_SUFFIX+".alts.selec.norm.exp."+REL_FILTER_SUFFIX+".aval";

	private static final String INVOKE_RELATIONS_REPORTER =
		"java -Dfile.encoding=ISO-8859-1 -cp .;lib/jdom.jar pt.linguateca.harem.GlobalRelationsEvaluatorM2 -alinhamento "+NAME+".rerelem2.alinhado.avalida."+FILTER_SUFFIX+".alts.selec.norm.exp."+REL_FILTER_SUFFIX+".aval > "+NAME+".rerelem2.alinhado.avalida."+FILTER_SUFFIX+".alts.selec.norm.exp."+REL_FILTER_SUFFIX+".aval.resumo";

	public RelationEvaluationScriptGenerator(){
	...
	public static void main(String args[]){
		...
		new RelationEvaluationScriptGenerator();
	}
